    ...
    <div className="flex-1 flex w-full px-8 sm:max-w-md justify-center items-center h-screen mx-auto relative z-10">
      ...
      <Card className="w-full relative z-10 border-border/50 bg-background/60">
        <CardHeader className="text-center">
          <Link href="/" className="mx-auto bg-primary/10 p-3 rounded-full mb-2 border border-primary/20 hover:bg-primary/20 transition-colors">
        ...
        <CardContent>
          <form className="animate-in flex-1 flex flex-col w-full justify-center gap-4 text-foreground" action={logIn}>
            ...
            <Button className="w-full mt-4 font-semibold">Sign In</Button>
